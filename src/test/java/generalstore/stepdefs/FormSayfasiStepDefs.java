...
public class FormSayfasiStepDefs {
    ...
    @When("Isim kutusunda {string} girilir")
    public void isim_kutusunda_girilir(String isim) {
    ...
    @When("Isim kutusunda bos birakilir")
    public void isim_kutusunda_bos_birakilir() {
